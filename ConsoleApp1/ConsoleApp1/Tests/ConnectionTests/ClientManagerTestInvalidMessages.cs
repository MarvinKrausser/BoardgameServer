...
[TestFixture]
public class ClientManagerTestInvalidMEssages
{
    ...
    public static int countNewClients = 0;
    ...
    public static void Do()
    {
        ...
        clientManager.Setup(54001, b, g, ClientManagerTest.GetPlayers, new BoardState());
        ...
        if (clients.Count != 0) Assert.Fail("Wrong number of Clients");
    ...
    public class ClientTest
    {
        ...
        public void Start()
        {
            WebSocket client = new WebSocket("ws://127.0.0.1:54001/");
            client.Connect();
